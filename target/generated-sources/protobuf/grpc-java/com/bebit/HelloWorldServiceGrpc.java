...
public final class HelloWorldServiceGrpc {
  ...
  public static final String SERVICE_NAME = "com.bebit.HelloWorldService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<com.bebit.User,
      com.bebit.Greeting> getSayHelloMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "sayHello",
      requestType = com.bebit.User.class,
      responseType = com.bebit.Greeting.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.bebit.User,
      com.bebit.Greeting> getSayHelloMethod() {
    io.grpc.MethodDescriptor<com.bebit.User, com.bebit.Greeting> getSayHelloMethod;
      ...
      synchronized (HelloWorldServiceGrpc.class) {
        if ((getSayHelloMethod = HelloWorldServiceGrpc.getSayHelloMethod) == null) {
          HelloWorldServiceGrpc.getSayHelloMethod = getSayHelloMethod = 
              io.grpc.MethodDescriptor.<com.bebit.User, com.bebit.Greeting>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(
                  "com.bebit.HelloWorldService", "sayHello"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.bebit.User.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.bebit.Greeting.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<com.bebit.User,
      com.bebit.User> getSaveUserMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "saveUser",
      requestType = com.bebit.User.class,
      responseType = com.bebit.User.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.bebit.User,
      com.bebit.User> getSaveUserMethod() {
    io.grpc.MethodDescriptor<com.bebit.User, com.bebit.User> getSaveUserMethod;
    if ((getSaveUserMethod = HelloWorldServiceGrpc.getSaveUserMethod) == null) {
      synchronized (HelloWorldServiceGrpc.class) {
        if ((getSaveUserMethod = HelloWorldServiceGrpc.getSaveUserMethod) == null) {
          HelloWorldServiceGrpc.getSaveUserMethod = getSaveUserMethod = 
              io.grpc.MethodDescriptor.<com.bebit.User, com.bebit.User>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(
                  "com.bebit.HelloWorldService", "saveUser"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.bebit.User.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.bebit.User.getDefaultInstance()))
                  .setSchemaDescriptor(new HelloWorldServiceMethodDescriptorSupplier("saveUser"))
                  .build();
          }
        }
     }
  ...
  public static abstract class HelloWorldServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void sayHello(com.bebit.User request,
        io.grpc.stub.StreamObserver<com.bebit.Greeting> responseObserver) {
      asyncUnimplementedUnaryCall(getSayHelloMethod(), responseObserver);
    }

    /**
     */
    public void saveUser(com.bebit.User request,
        io.grpc.stub.StreamObserver<com.bebit.User> responseObserver) {
  ...
  public static final class HelloWorldServiceBlockingStub extends io.grpc.stub.AbstractStub<HelloWorldServiceBlockingStub> {
    ...
    /**
     */
    public com.bebit.Greeting sayHello(com.bebit.User request) {
    ...
    /**
     */
    public com.bebit.User saveUser(com.bebit.User request) {
      return blockingUnaryCall(
  ...
  public static final class HelloWorldServiceFutureStub extends io.grpc.stub.AbstractStub<HelloWorldServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.bebit.Greeting> sayHello(
        com.bebit.User request) {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.bebit.User> saveUser(
        com.bebit.User request) {
      return futureUnaryCall(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_SAY_HELLO:
          serviceImpl.sayHello((com.bebit.User) request,
              (io.grpc.stub.StreamObserver<com.bebit.Greeting>) responseObserver);
          break;
        case METHODID_SAVE_USER:
          serviceImpl.saveUser((com.bebit.User) request,
              (io.grpc.stub.StreamObserver<com.bebit.User>) responseObserver);
          break;
        default:
  ...
  private static abstract class HelloWorldServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.bebit.HelloWorld.getDescriptor();
    }
